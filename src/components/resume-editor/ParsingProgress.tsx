...
export function useParsingProgress() {
    const [stages, setStages] = useState<ParsingStage[]>([
        ...
        {
            id: 'stage4_master-merge',
            title: 'Building Master Profile',
            description: 'Combining resume and LinkedIn data',
            logs: [],
            status: 'pending',
        },
        {
            ...
            description: 'Extracting requirements and matching against Master Profile',
            logs: [],
            status: 'pending',
        },
        {
            ...
            description: 'Rewriting bullets and optimizing for ATS',
            logs: [],
            status: 'pending',
        },
        {
            ...
            description: 'Applying design template and styles',
            logs: [],
            status: 'pending',
        },
    ]);
