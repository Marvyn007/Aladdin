...
export function AtsScoreWidget({ keywords, resume, editorResume, updatePreview, setKeywords }: AtsScoreWidgetProps) {
    ...
    return (
        <div style={{ padding: '20px 14px', borderBottom: '1px solid #f1f5f9', background: '#ffffff', display: 'flex', flexDirection: 'column', alignItems: 'stretch', width: '100%', boxSizing: 'border-box' }}>
            <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1e293b', marginBottom: '16px', textAlign: 'center' }}>Resume ATS Score</h3>
            ...
            {/* New Keyword Match Line */}
            <div style={{ width: '100%', textAlign: 'left', marginTop: '12px', padding: '10px 12px', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            {/* Missing Keywords you can manually add */}
            {keywords.missing.length > 0 && (
                <div style={{ width: '100%', textAlign: 'left', marginTop: '14px' }}>
